...
**As-of:** 2026-09-24 · Phase 1 paper wiring.
...
| G7 DOGE trend edge | INSUFFICIENT_EVIDENCE | Skeleton fires on synthetic bars. That is not expectancy after costs and not OOS. | `test_doge_trend_retest_primary_and_four_h_veto`, smoke. No 12-month claim. |
...
- G7: a pre-registered paper walk on public candles, costs on, no promotion from one window.
