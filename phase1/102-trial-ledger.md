...
| `TL-120` | [`120`](./120-kaje-risk-scalp-live-gate-2026-09-12.md) | `N/A_live_gate_lock_not_a_score` (PEPE LIVE GATE: LIVE_CLEAR_BOTH PEPE-USDC + X-Perp-310404; settleCcy USDC confirm-before-place; DEMO_BLOCK still; no POST until 121 + PEPE rescore + session-ja; Soft PASS ≠ Scalp-arm) |
