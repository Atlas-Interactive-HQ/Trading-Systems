...
**Next Mid score = unseen SHADOW only** — meaning the **contiguous** interval in [`101`](./101-shadow-contiguous-methodology.md), not hand-picked rise/chop/down windows. Do **not** run M2 / M3 / M4 on R1–R7. Do **not** invent SHADOW dates in this freeze.
...
- Next evidence for Mid: contiguous unseen SHADOW ([`101`](./101-shadow-contiguous-methodology.md)), locked **before** scoring, then walk-forward, then forward paper. Hand-picked S/F/D windows are not that SHADOW.
