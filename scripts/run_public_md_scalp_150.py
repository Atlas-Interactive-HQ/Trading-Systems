#!/usr/bin/env python3
"""Public-MD Scalp #150 — D1/D2/D3 regime soften. Paper only.
...
from atlas.paper.public_md_scalp_150 import (  # noqa: E402
    OFFICIAL_CELLS,
    measured_table_rows,
    run_150_score,
    write_report_json,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #150: D1/D2/D3 Q4 regime soften "
    ...
    p.add_argument(
        ...
        help="Comma-separated D1,D2,D3 (default all)",
    )
    ...
    out_path = (
        Path(args.out) if args.out else reports / "public_md_scalp_150.json"
    )
    ...
    results_path = results_dir / "public_md_scalp_150.json"
