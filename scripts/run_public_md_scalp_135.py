#!/usr/bin/env python3
"""Public-MD Scalp #135 — S1–S4 hold-strengthen A/C/F/G Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–134.
Do NOT grind N/k/RVOL/Donchian/ST/Keltner. No D/J. No 136.
"""
...
from atlas.paper.public_md_scalp_135 import (  # noqa: E402
    OFFICIAL_CELLS,
    measured_table_rows,
    run_135_score,
    write_report_json,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #135: S1=F / S2=G / S3=C A-style exits; "
            "S4=A ATR trail 2×ATR14; BTC/ETH/DOGE-USDT Jul2020–Jan2021 €20."
        )
    )
    ...
    p.add_argument(
        ...
        help="Comma-separated S1,S2,S3,S4 (default all official)",
    )
    ...
    out_path = (
        Path(args.out) if args.out else reports / "public_md_scalp_135.json"
    )
    ...
    results_path = results_dir / "public_md_scalp_135.json"
