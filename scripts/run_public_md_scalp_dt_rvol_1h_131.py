#!/usr/bin/env python3
"""Public-MD Scalp #131 — Dual Thrust N4 + RVOL 1H + 4H EMA21 Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–130.
Do NOT grind N/k/RVOL/EMA/R/time-stop/TF. Leave #130 15m STOP. Do NOT take 132.
"""
...
from atlas.paper.public_md_scalp_dt_rvol_1h_131 import (  # noqa: E402
    measured_table_rows,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #131: Dual Thrust N4 + RVOL>1.2 1H + 4H EMA21 "
    ...
    out_path = (
        Path(args.out)
        if args.out
        else reports / "public_md_scalp_dt_rvol_1h_131.json"
    )
    if not out_path.is_absolute():
        out_path = _ROOT / out_path

    try:
        bundle = run_dt_rvol_1h_131_score(
            cfg,
            data_dir=data_dir,
    ...
    results_path = results_dir / "public_md_scalp_dt_rvol_1h_131.json"
    ...
    public = {
        ...
        "vs_130_full": bundle.get("vs_130_full"),
