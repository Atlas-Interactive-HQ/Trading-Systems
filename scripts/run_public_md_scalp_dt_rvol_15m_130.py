#!/usr/bin/env python3
"""Public-MD Scalp #130 — Dual Thrust N4 + RVOL 15m + 1H EMA21 Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–129.
Do NOT grind N/k/RVOL/EMA/R/time-stop. Do NOT take 131.
"""
...
from atlas.paper.public_md_scalp_dt_rvol_15m_130 import (  # noqa: E402
    measured_table_rows,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #130: Dual Thrust N4 + RVOL>1.2 15m + 1H EMA21 "
    ...
    out_path = (
        Path(args.out)
        if args.out
        else reports / "public_md_scalp_dt_rvol_15m_130.json"
    )
    if not out_path.is_absolute():
        out_path = _ROOT / out_path

    try:
        bundle = run_dt_rvol_15m_130_score(
            cfg,
            data_dir=data_dir,
    ...
    results_path = results_dir / "public_md_scalp_dt_rvol_15m_130.json"
    ...
    public = {
        ...
        "vs_126_full": bundle.get("vs_126_full"),
        "vs_121_dt_rvol_full": bundle.get("vs_121_dt_rvol_full"),
        "series_n_bars_15m": bundle.get("series_n_bars_15m"),
        "series_n_bars_1h": bundle.get("series_n_bars_1h"),
        "series_n_bars_full_trade_15m": bundle.get("series_n_bars_full_trade_15m"),
