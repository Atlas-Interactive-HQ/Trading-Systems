#!/usr/bin/env python3
"""CLI: run OKX EEA PUBLIC collector (smoke / continuous)."""
...
from atlas.collectors.okx_eea_public import OkxEeaPublicCollector  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="OKX EEA PUBLIC MD collector (no API keys)")
