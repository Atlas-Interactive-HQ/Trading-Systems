#!/usr/bin/env python3
"""Public-MD Scalp #140 — E1 seed / E2 EMA12 / E3 EMA50+100 Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–139.
Do NOT grind. No D2 shorts. No 141. n_sl=0 and n_time_stop=0.
"""
...
from atlas.paper.public_md_scalp_140 import (  # noqa: E402
    OFFICIAL_CELLS,
    measured_table_rows,
    run_140_score,
    write_report_json,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #140: E1=D3+seed / E2=EMA12-in / E3=EMA50+100-out; "
    ...
    p.add_argument(
        ...
        help="Comma-separated E1,E2,E3 (default all official)",
    )
    ...
    out_path = (
        Path(args.out) if args.out else reports / "public_md_scalp_140.json"
    )
    ...
    results_path = results_dir / "public_md_scalp_140.json"
    ...
    public = {
        ...
        "pairs_term_ge_bh": bundle.get("pairs_term_ge_bh"),
        ...
        "by_sid_gates": {
            sid: {
                ...
                "pairs_term_ge_bh": block.get("pairs_term_ge_bh"),
            }
