#!/usr/bin/env python3
"""Public-MD Scalp #137 — N1 Donchian + N2 Keltner 1D EMA21 flip, NO ts Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–136.
Do NOT grind Keltner/Donchian. No S4/D/J. No 138.
Note: #136 1D flip DID run (ts rare); this run removes ts as locked.
"""
...
from atlas.paper.public_md_scalp_137 import (  # noqa: E402
    OFFICIAL_CELLS,
    measured_table_rows,
    run_137_score,
    write_report_json,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #137: N1=Donchian / N2=Keltner 1D EMA21 flip + NO ts; "
    ...
    p.add_argument(
        ...
        help="Comma-separated N1,N2 (default all official)",
    )
    ...
    out_path = (
        Path(args.out) if args.out else reports / "public_md_scalp_137.json"
    )
    ...
    results_path = results_dir / "public_md_scalp_137.json"
