#!/usr/bin/env python3
"""Public-MD Scalp #127 — #126 + BOS follow-through + RSI 20-30/67 Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–126.
"""
...
from atlas.paper.public_md_scalp_structure_bos_127 import (  # noqa: E402
    measured_table_rows,
...
def main(argv: list[str] | None = None) -> int:
    ...
    out_path = (
        Path(args.out)
        if args.out
        else reports / "public_md_scalp_structure_bos_127.json"
    )
    if not out_path.is_absolute():
        out_path = _ROOT / out_path

    try:
        bundle = run_structure_bos_127_score(
            cfg,
            data_dir=data_dir,
    ...
    results_path = results_dir / "public_md_scalp_structure_bos_127.json"
    ...
    public = {
        ...
        "parent_126_gate_verdict": bundle.get("parent_126_gate_verdict"),
