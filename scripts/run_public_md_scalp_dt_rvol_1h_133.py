#!/usr/bin/env python3
"""Public-MD Scalp #133 — #132 entry + 4H EMA21 regime-flip exits Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–132.
Do NOT grind N/k/RVOL/EMA/TF. Leave #130/#131/#132 STOP. Do NOT take 134.
"""
...
from atlas.paper.public_md_scalp_dt_rvol_1h_133 import (  # noqa: E402
    measured_table_rows,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #133: Dual Thrust N20 + RVOL>1.0 1H + 4H EMA21 "
            "regime-flip exits BTC/ETH/DOGE-USDT Jul2020–Jan2021 €20."
        )
    )
    ...
    out_path = (
        Path(args.out)
        if args.out
        else reports / "public_md_scalp_dt_rvol_1h_133.json"
    )
    if not out_path.is_absolute():
        out_path = _ROOT / out_path

    try:
        bundle = run_dt_rvol_1h_133_score(
            cfg,
            data_dir=data_dir,
    ...
    results_path = results_dir / "public_md_scalp_dt_rvol_1h_133.json"
    ...
    public = {
        ...
        "vs_132_full": bundle.get("vs_132_full"),
        ...
        "table_sub_b": [
            r for r in table if r.get("window_key") == "SUB_B_BTC_RUN"
        ],
    }
