#!/usr/bin/env python3
"""Public-MD Scalp #136 — L1 Keltner + L2 Donchian 1D EMA21 hold Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–135.
Do NOT grind Keltner/Donchian. No S4/D/J. No 137.
"""
...
from atlas.paper.public_md_scalp_136 import (  # noqa: E402
    OFFICIAL_CELLS,
    measured_table_rows,
    run_136_score,
    write_report_json,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #136: L1=Keltner / L2=Donchian 1D EMA21 flip + ts504; "
    ...
    p.add_argument(
        ...
        help="Comma-separated L1,L2 (default all official)",
    )
    ...
    out_path = (
        Path(args.out) if args.out else reports / "public_md_scalp_136.json"
    )
    ...
    results_path = results_dir / "public_md_scalp_136.json"
