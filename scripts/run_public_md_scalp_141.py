...
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–140.
Do NOT grind. No D2 shorts. No 142. n_sl=0 and n_time_stop=0.
"""
...
from atlas.paper.public_md_scalp_141 import (  # noqa: E402
    OFFICIAL_CELLS,
    measured_table_rows,
    run_141_score,
    write_report_json,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #141: F1=hold-to-end / F2=sticky3 / F3=sticky dual; "
    ...
    p.add_argument(
        ...
        help="Comma-separated F1,F2,F3 (default all official)",
    )
    ...
    out_path = (
        Path(args.out) if args.out else reports / "public_md_scalp_141.json"
    )
    ...
    results_path = results_dir / "public_md_scalp_141.json"
    ...
    public = {
        ...
        "structural_ceiling_f1": bundle.get("structural_ceiling_f1"),
