#!/usr/bin/env python3
"""Public-MD Scalp #126 — #125 long-only 15m-bull strengthen Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–125.
"""
...
from atlas.paper.public_md_scalp_structure_bos_126 import (  # noqa: E402
    measured_table_rows,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #126: #125 long-only 15m-bull strengthen "
    ...
    out_path = (
        Path(args.out)
        if args.out
        else reports / "public_md_scalp_structure_bos_126.json"
    )
    if not out_path.is_absolute():
        out_path = _ROOT / out_path

    try:
        bundle = run_structure_bos_126_score(
            cfg,
            data_dir=data_dir,
    ...
    results_path = results_dir / "public_md_scalp_structure_bos_126.json"
    ...
    public = {
        ...
        "long_only": True,
        "vs_125_full": bundle.get("vs_125_full"),
        "parent_125_gate_verdict": bundle.get("parent_125_gate_verdict"),
