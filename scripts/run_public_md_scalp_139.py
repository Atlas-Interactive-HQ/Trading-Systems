#!/usr/bin/env python3
"""Public-MD Scalp #139 — D1 no-SL / D2 always-in / D3 dual-EMA Jul2020–Jan2021 €20.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–138.
Do NOT grind. No S4/D/J. No 140. n_sl=0 and n_time_stop=0.
"""
...
from atlas.paper.public_md_scalp_139 import (  # noqa: E402
    OFFICIAL_CELLS,
    measured_table_rows,
    run_139_score,
    write_report_json,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #139: D1=C2 no-SL / D2=always-in / D3=dual-EMA; "
    ...
    p.add_argument(
        ...
        help="Comma-separated D1,D2,D3 (default all official)",
    )
    ...
    out_path = (
        Path(args.out) if args.out else reports / "public_md_scalp_139.json"
    )
    ...
    results_path = results_dir / "public_md_scalp_139.json"
