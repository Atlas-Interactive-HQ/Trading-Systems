#!/usr/bin/env python3
"""Public-MD Scalp #142 — notebook stack M1/M2/M3. Paper only.

Never places orders. Does NOT change config/default.yaml.
not_a_forecast. Soft PASS N/A ≠ arm. Do not edit phase1/120–141.
"""
...
from atlas.paper.public_md_scalp_142 import (  # noqa: E402
    OFFICIAL_CELLS,
    measured_table_rows,
    run_142_score,
    write_report_json,
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        description=(
            "Public-MD Scalp #142: notebook 4H/1H/15m/1m stack M1/M2/M3 "
    ...
    p.add_argument(
        ...
        help="Comma-separated M1,M2,M3 (default all official)",
    )
    ...
    out_path = (
        Path(args.out) if args.out else reports / "public_md_scalp_142.json"
    )
    ...
    results_path = results_dir / "public_md_scalp_142.json"
    ...
    public = {
        ...
        "m3_included": bundle.get("m3_included"),
        "m3_skip_reason": bundle.get("m3_skip_reason"),
