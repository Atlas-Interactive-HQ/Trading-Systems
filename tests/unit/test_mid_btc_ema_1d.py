"""Unit tests: Mid BTC EMA12/30 1D Core-style RETURN gate (#51)."""

from __future__ import annotations

from atlas.paper.cascade import MID_START_EUR
from atlas.paper.mid_btc_ema_1d_eval import (
    BAR,
    BH_DD_MULT,
...
from atlas.strategy.mid_btc_ema_1d import MidBtcEma1dParams, MidBtcEma1dV1
...
def test_strategy_never_short_and_label():
    strat = MidBtcEma1dV1(MidBtcEma1dParams(fast=12, slow=30))
    assert strat.label.startswith("mid_btc_ema_1d")
...
def test_differs_from_4h_trial():
    """#51 is 1D daily Mid — not the 4H #49 twin."""
    assert BAR == "1D"
    assert SOURCE == "mid_btc_ema_1d"
