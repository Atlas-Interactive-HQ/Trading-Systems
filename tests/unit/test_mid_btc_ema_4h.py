"""Unit tests: Mid BTC EMA12/30 4H Core-style RETURN gate (#49)."""

from __future__ import annotations

from atlas.paper.cascade import MID_START_EUR
from atlas.paper.mid_btc_ema_4h_eval import (
    BAR,
    BH_DD_MULT,
...
from atlas.strategy.mid_btc_ema_4h import MidBtcEma4hParams, MidBtcEma4hV1
...
def test_strategy_never_short_and_label():
    strat = MidBtcEma4hV1(MidBtcEma4hParams(fast=12, slow=30))
    assert strat.label.startswith("mid_btc_ema_4h")
